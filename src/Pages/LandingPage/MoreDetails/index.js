            ...
            <div className='font'>
                ...
                <div className={'details-container'}>
                    <div className={'glasbern-container'}>
                        <div>
                            <div className={'title main'}>Where to celebrate?</div>
                    ...
                    <div className={'glasbern-container'}>
                        <div>
                            <div className={'title main'}>Where to stay?</div>
                    ...
                    <div className={'directions'}>
                        <div className={'title main'}>How to get here?</div>
                        ...
                        <div className={'icon-credit'}>
                            <div>Icons made by&nbsp;
                                ...
                                <a href="https://www.flaticon.com/authors/freepik" title="Circus Llama">Circus Llama</a>&nbsp;
